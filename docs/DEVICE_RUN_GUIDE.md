...
| 기능 | 무료 Apple ID | 비고 |
|------|--------------|------|
| 디데이·순공·플래너·내 바다·운동·러닝·통계 | ✅ | 단일 기기에서 전부 동작 |
| LiveActivity (잠금화면 타이머) | ✅ | |
| 홈스크린 위젯 (디데이·오늘·내 바다) | ✅ | App Group 자동 등록 |
...
- [ ] 홈스크린 길게 누름 → 위젯 추가 → "SJ" 검색 → 디데이 / 오늘 순공 / 내 바다 위젯 추가
- [ ] 8시간 학습 → 플래너 탭에서 색 채워진 칸 확인
- [ ] 일일 목표 채운 후 → 바다 영양분 증가 + 알림 "오늘 목표 달성!"
