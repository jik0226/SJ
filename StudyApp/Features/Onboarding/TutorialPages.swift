...
/// Page 4: live ocean preview — the core differentiator. Renders a
/// deterministic sample so new users see the visual payoff before they've
/// logged any real study/workout minutes.
struct TutorialOceanPage: View {
    private let previewParameters = PlantFormula.parameters(
        seed: 12345,
